...
class GameUiAssets: 
	...
	# 检查麒麟 
	I_CHECK_KIRIN = RuleImage(roi_front=(88,13,105,46), roi_back=(88,13,105,46), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_kirin.png")
