...
class GameUiAssets: 
	...
	# 庭院卷轴打开 
	I_MAIN_SCROLL_OPEN = RuleImage(roi_front=(1208,609,33,83), roi_back=(1208,609,33,83), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_main_scroll_open.png")
	# description 
	...
	# description 
	I_CHECK_DUEL = RuleImage(roi_front=(158,17,58,39), roi_back=(89,6,147,66), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_duel.png")
	# description 
