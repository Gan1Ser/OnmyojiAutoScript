...
class GameUiAssets: 
	...
	# 秘闻 
	I_EXPLORATION_GOTO_SECRET_ZONES = RuleImage(roi_front=(545,650,52,32), roi_back=(524,614,100,87), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_secret_zones.png")
	# 地狱鬼王 
