...
class GameUiAssets: 
	...
	# 庭院卷轴打开 
	I_MAIN_SCROOLL_OPEN = RuleImage(roi_front=(1208,609,33,83), roi_back=(1208,609,33,83), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_main_scroll_open.png")
	# description 
