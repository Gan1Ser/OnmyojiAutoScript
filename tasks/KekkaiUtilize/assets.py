...
class KekkaiUtilizeAssets: 
	...
	# 梦狐之乡_收取盒子的经验（没有满） 
	I_BOX_EXP_1 = RuleImage(roi_front=(988,447,42,45), roi_back=(881,406,225,138), threshold=0.7, method="Template matching", file="./tasks/KekkaiUtilize/realm/realm_box_exp_1.png")
	# 结界皮肤 
	...
	# 梦狐之乡_盒子经验满 
	I_BOX_EXP_MAX_1 = RuleImage(roi_front=(978,443,61,64), roi_back=(829,372,228,186), threshold=0.7, method="Template matching", file="./tasks/KekkaiUtilize/realm/realm_box_exp_max_1.png")
