...
class DailyTriflesAssets: 
	...
	# description 
	I_GIFT_RECOMMEND = RuleImage(roi_front=(1194,191,31,60), roi_back=(1172,83,83,306), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/store/store_gift_recommend.png")
	# 免费一抽 
