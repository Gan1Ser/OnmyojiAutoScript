...
class DailyTriflesAssets: 
	...
	# description 
	I_STORE_ROOM_GIFT = RuleImage(roi_front=(1124,634,81,79), roi_back=(1124,634,81,79), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/store/store_store_room_gift.png")
