...
class RestartAssets: 
	...
	# description 
	I_LOGIN_RED_CLOSE = RuleImage(roi_front=(849,108,52,21), roi_back=(849,108,52,21), threshold=0.7, method="Template matching", file="./tasks/Restart/login/login_login_red_close.png")
	# description 
