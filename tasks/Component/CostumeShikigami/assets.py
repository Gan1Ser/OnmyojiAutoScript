...
class CostumeShikigamiAssets: 
	...
	# Image Rule Assets
	# 用于判断在式神录 
	I_CHECK_RECORDS_6 = RuleImage(roi_front=(267,76,51,46), roi_back=(265,74,55,50), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_check_records_6.png")
	# 退出式神录 
	...
	# 第二组切换 
	I_SOU_SWITCH_2_6 = RuleImage(roi_front=(973,293,33,33), roi_back=(973,293,33,33), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_switch_2_6.png")
	# description 
	I_SOU_SWITCH_3_6 = RuleImage(roi_front=(968,448,41,38), roi_back=(968,448,41,38), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_switch_3_6.png")
	# description 
	I_SOU_SWITCH_4_6 = RuleImage(roi_front=(967,597,42,25), roi_back=(967,597,42,25), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_switch_4_6.png")
	# description 
	...
	# 用于判断是否在式神录里面 
	I_SOU_CHECK_IN_6 = RuleImage(roi_front=(268,74,50,49), roi_back=(268,74,50,49), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_in_6.png")
	# 检查是否为第一组 
	I_SOU_CHECK_GROUP_1_6 = RuleImage(roi_front=(1083,78,22,57), roi_back=(1083,78,22,57), threshold=0.9, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_group_1_6.png")
	# description 
	I_SOU_CHECK_GROUP_2_6 = RuleImage(roi_front=(1083,150,21,57), roi_back=(1083,150,21,57), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_group_2_6.png")
	# description 
	I_SOU_CHECK_GROUP_3_6 = RuleImage(roi_front=(1083,224,22,49), roi_back=(1083,224,22,49), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_group_3_6.png")
	# description 
	I_SOU_CHECK_GROUP_4_6 = RuleImage(roi_front=(1082,291,21,56), roi_back=(1082,291,21,56), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_group_4_6.png")
	# description 
	I_SOU_CHECK_GROUP_5_6 = RuleImage(roi_front=(1083,361,21,53), roi_back=(1083,361,21,53), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_group_5_6.png")
	# description 
	I_SOU_CHECK_GROUP_6_6 = RuleImage(roi_front=(1084,430,21,54), roi_back=(1084,430,21,54), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_group_6_6.png")
	# description 
	I_SOU_CHECK_GROUP_7_6 = RuleImage(roi_front=(1084,502,21,54), roi_back=(1084,502,21,54), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_check_group_7_6.png")
	# 匹配队伍预设 
	I_SOU_TEAM_PRESENT_6 = RuleImage(roi_front=(720,76,136,43), roi_back=(720,76,136,43), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_team_present_6.png")
	# 需要切换的预设按钮(颜色深一点) 
	I_SOU_CLICK_PRESENT_6 = RuleImage(roi_front=(967,305,43,22), roi_back=(967,305,43,22), threshold=0.9, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_sou_click_present_6.png")
	# 点击御魂 
	I_ST_SOULS_6 = RuleImage(roi_front=(1176,227,70,80), roi_back=(1176,227,70,80), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_st_souls_6.png")
	# 更换 
	I_ST_REPLACE_6 = RuleImage(roi_front=(858,162,100,100), roi_back=(858,162,100,100), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk6/sk6_st_replace_6.png")
