...
class GeneralInviteAssets: 
	...
	# description 
	I_FIRE = RuleImage(roi_front=(1188,609,60,68), roi_back=(1188,609,60,68), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_fire.png")
	# 锁定阵容的图片 
