...
class GeneralBuffAssets: 
	...
	# Ocr Rule Assets
	# Ocr-description 
	O_GOLD_50 = RuleOcr(roi=(425,116,347,389), area=(428,267,335,44), mode="Full", method="Default", keyword="战斗胜利获得的金币增加50%", name="gold_50")
	# Ocr-description 
	O_GOLD_100 = RuleOcr(roi=(425,123,342,397), area=(428,336,334,40), mode="Full", method="Default", keyword="战斗胜利获得的金币增加100%", name="gold_100")
	# Ocr-description 
	O_EXP_50 = RuleOcr(roi=(424,115,342,394), area=(427,403,334,38), mode="Full", method="Default", keyword="战斗胜利获得的经验增加50%", name="exp_50")
	# Ocr-description 
	O_EXP_100 = RuleOcr(roi=(424,121,342,388), area=(427,334,339,47), mode="Full", method="Default", keyword="战斗胜利获得的经验增加100%", name="exp_100")
	# 打开buff加成 
