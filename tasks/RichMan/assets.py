...
class RichManAssets: 
	...
	# 蓝票 
	I_GUILD_BLUE = RuleImage(roi_front=(344,216,73,73), roi_back=(248,162,722,433), threshold=0.8, method="Template matching", file="./tasks/RichMan/guild/guild_guild_blue.png")
	# 黑蛋碎片 
